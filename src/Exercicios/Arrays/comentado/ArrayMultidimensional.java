package Exercicios.Arrays.comentado;
...
public class ArrayMultidimensional {
    public static void main(String[] args) {
        ...
        // para: variável i = 0, até i menor que o tamanho da matriz (array
        // multidimencional), acrescentamos 1 ao valor de i a cada loop.
        for (int i = 0; i < M.length; i++) { // navegando na matriz
            // para: variável j = 0, até i menor que o tamanho da linha, acrescentamos 1 ao
            // valor de i a cada loop.
